...
class OpenWeatherServiceResponses {
    companion object {
        fun getCurrentWeatherResponseCorrect() =
        ...
        fun getCurrentLocationSuccessResponses() =
            listOf(
                GeocodeResponse(
                    longitude = -96.9489f,
                    latitude = 32.814f,
        ...
        fun getResponseErrorBody() = """{"code": "404", "message": "not found"}""".toResponseBody("application/json".toMediaTypeOrNull())
    }
}
