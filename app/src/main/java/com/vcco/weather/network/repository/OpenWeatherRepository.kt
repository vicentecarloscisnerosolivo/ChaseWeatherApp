...
class OpenWeatherRepository @Inject constructor(
    ...
    fun getCurrentWeatherFromLocation(location: String, unit: String) =
     ...
     *                 State and Country
     */
    fun getLocationInfoFromName(location: String) =
        helper.getLocationInfoFromName(query = location)
    ...
    fun getInfoFromZipCode(zipCode: String) =
        helper.getInfoFromZipCode(zip = zipCode)
